...
namespace Cloudinary {
    ...
    class UploaderTest extends IntegrationTestBase
    {
        ...
        {
            Cloudinary::config(array("cloud_name" => "test123", "secure_distribution" => null, "private_cdn" => false, "api_key" => self::API_KEY_WRONG));
